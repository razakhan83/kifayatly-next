...
export default function HomeClientWrapper({ products, heroSlides }) {
  ...
  return (
    <>
      ...
      <div
        className="md:hidden container mx-auto max-w-[600px] px-4 pt-6 mb-2 relative"
        ref={wrapperRef}
      >
        <form
        ...
        >
          ...
          <Button
            type="submit"
            className="rounded-full px-4 h-12 shrink-0 min-w-max"
          >
            Search
          </Button>
        </form>
